  ...
  return(
    shinydashboard::dashboardPage(
      ...
      shinydashboard::dashboardSidebar(
        ...
        shiny::tags$style(
          HTML(".sidebar-menu { padding-bottom: 50px; }"),  # Adjust the padding as needed
          HTML(".sidebar { overflow-y: auto; }")  # Enable scrolling if necessary
        ),
        shiny::div(
          shiny::actionButton("viewSummary", "View Summary"),
          shiny::actionButton("addSidebar", "Add Sidebar"),
          shiny::actionButton("hideSidebar", "Hide Sidebar")
        )
      ),
